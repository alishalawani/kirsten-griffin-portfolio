  ...
  return (
    <section>
      ...
      <div className="reel-container">
        ...
        <img src={PlayPauseOuterCircle} alt="play-btn-outer-circle" className='play-btn-outer-circle'/>
         <img src={PlayPauseInnerCircle} alt="play-btn-inner-circle" className='play-btn-inner-circle'/>
         <span>  {isPlaying ? 'Pause' : 'Play'}</span>
          
        </button>
        <Stack spacing={2} direction="row" sx={{ mb: 1 }} alignItems="center" width={'80%'} className='progress-bar-container'>
          <Slider
           ref={sliderRef}
           size="small"
            aria-label="duration"
        ...
        <div className="social-buttons"> <button className='social-btn'><img src={SocialCircle} alt="social container"className='social-media-circle'/> <FacebookIcon className='social-icon'/> </button></div>
